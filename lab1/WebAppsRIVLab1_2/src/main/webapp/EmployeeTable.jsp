...
<%@ page import="ntukhpi.csit.semit.riv.webappsrivlab1_2.model.*" %>
...
<body class="mx-3 my-3 font-monospace">
<h1 class="text-info fs-1 mb-3 fw-semibold">
    Employee Table
</h1>
...
<div class="d-flex justify-content-center">
    <a href="/WebAppsRIVLab1_2/hello-web-world" class="btn btn-outline-info" role="button">Go Back</a>
</div>
</body>
</html>
