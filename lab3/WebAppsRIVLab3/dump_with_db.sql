...
--
-- Host: localhost    Database: webappsrivlab3
-- ------------------------------------------------------
...
--
-- Current Database: `webappsrivlab3`
--

/*!40000 DROP DATABASE IF EXISTS `webappsrivlab3`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `webappsrivlab3` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `students` (
  ...
  CONSTRAINT `students_chk_1` CHECK ((regexp_like(`corporate_email`,_utf8mb4'^[a-z](.?[a-z]+){1,99}@[a-z]{1,10}.khpi.edu.ua$',_utf8mb4'c') = 1))
...
-- Dump completed on 2024-11-08  9:42:34
